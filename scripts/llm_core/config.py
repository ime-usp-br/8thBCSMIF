...
TEMP_CONTEXT_COPY_DIR = (
    PROJECT_ROOT / "context_llm" / "temp"
)  # AC3: Diretório temporário para cópia de contexto
...
ESTIMATED_TOKENS_PER_SUMMARY = 100  # Rough estimate for a single summary
...
DEFAULT_CONTEXT_GENERATION_TIMEOUT = 1200  # 20 minutes
