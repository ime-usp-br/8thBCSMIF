        ...
        try {
            ...
            $this->js('
                const formData = {
                    ...
                    dietary_restrictions: "' . addslashes($this->dietary_restrictions) . '",
                    other_dietary_restrictions: "' . addslashes($this->other_dietary_restrictions) . '",
                    ...
                    <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-6">
                        <div class="flex items-start">
                            ...
                            <div class="text-sm text-blue-800 dark:text-blue-200">
                                ...
                                <p>{{ __('If you have any doubt or inconvenience during the registration, please send an email to') }} 
                                    <a href="mailto:{{ config('mail.coordinator_email') }}" class="font-medium underline hover:no-underline">
